...
| `drive/bin/polly_reconcile.php` | ninguna |
| `drive/bin/sync_node_worker.php` | ninguna |
| `drive/bin/sync_schema_migrate.php` | ninguna |
| `drive/bin/sync_worker.php` | `drive/src/Http/Controller/SyncController.php`, `drive/src/Sync/SyncJobStore.php` |
