class ArchivosModule {
  ...
  init() {
    ...
    */
    ...
    if (typeof getBloqueArchivosContext === 'function' && typeof window.getBloqueArchivosContext !== 'function') window.getBloqueArchivosContext = getBloqueArchivosContext;
    if (typeof llenarModalRenombrarArchivo === 'function' && typeof window.llenarModalRenombrarArchivo !== 'function') window.llenarModalRenombrarArchivo = llenarModalRenombrarArchivo;
    if (typeof ensureSecurityModal === 'function' && typeof window.ensureSecurityModal !== 'function') window.ensureSecurityModal = ensureSecurityModal;
    return this;
  }
  ...
  static boot(win = window, doc = document) {
    ...
    const instance = new ArchivosModule(win, doc).init();
    win.ArcadeCloudDrive.modules['archivos'] = instance;
    return instance;
  }
}
