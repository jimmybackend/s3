class EliminaMultipleModule {
  ...
  static boot(win = window, doc = document) {
    ...
    const instance = new EliminaMultipleModule(win, doc).init();
    win.ArcadeCloudDrive.modules['elimina-multiple'] = instance;
    return instance;
  }
}

EliminaMultipleModule.boot();
