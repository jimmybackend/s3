class ObtenerFiltrosModule {
  ...
  static boot(win = window, doc = document) {
    ...
    const instance = new ObtenerFiltrosModule(win, doc).init();
    win.ArcadeCloudDrive.modules['obtenerFiltros'] = instance;
    return instance;
  }
}

ObtenerFiltrosModule.boot();
