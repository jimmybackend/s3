class PollyModule {
  ...
  init() {
    ...
    if (typeof generarAudioPolly === 'function' && typeof window.generarAudioPolly !== 'function') window.generarAudioPolly = generarAudioPolly;
    if (typeof pintarRekognition === 'function' && typeof window.pintarRekognition !== 'function') window.pintarRekognition = pintarRekognition;
    if (typeof URLS !== 'undefined' && typeof window.URLS === 'undefined') window.URLS = URLS;
    return this;
  }
  ...
  static boot(win = window, doc = document) {
    ...
    const instance = new PollyModule(win, doc).init();
    win.ArcadeCloudDrive.modules['polly'] = instance;
    return instance;
  }
}
