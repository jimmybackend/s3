...
final class FederationNodeAdminController
{
    ...
    public function api(): void
    {
        ...
        if (!$session->isSuperAdmin()) {
            JsonResponse::send(['ok' => false, 'error' => 'Sólo un superusuario puede modificar la identidad visible del nodo.'], 403);
        }
        ...
        try {
            ...
            JsonResponse::send(['ok' => false, 'error' => 'No se pudo actualizar la identidad visible del nodo.'], 500);
        }
    }
}
