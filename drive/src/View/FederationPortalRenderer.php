...
<main class="federation-portal-shell">
  <div class="federation-portal-header">
    <div>
      ...
      <p class="text-muted mb-0">Busca en el catálogo global local, administra solicitudes y consulta Shares sin listar S3 ni depender de un nodo matriz.</p>
    </div>
    <?php if ($node): ?>
    ...
    <div class="tab-content federation-portal-content">
      ...
      <section class="tab-pane fade" id="federationRequestsPane" role="tabpanel">
        <div class="row">
          <div class="col-lg-6 mb-3">
            <div class="federation-panel h-100">
              <div class="d-flex justify-content-between align-items-center mb-3"><h2 class="h5 mb-0">Recibidas</h2><span id="federationIncomingCount" class="badge badge-secondary">0</span></div>
              <div id="federationIncomingList"><div class="small text-muted">Cargando...</div></div>
            </div>
          </div>
          <div class="col-lg-6 mb-3">
            <div class="federation-panel h-100">
              <div class="d-flex justify-content-between align-items-center mb-3"><h2 class="h5 mb-0">Enviadas</h2><span id="federationOutgoingCount" class="badge badge-secondary">0</span></div>
              <div id="federationOutgoingList"><div class="small text-muted">Cargando...</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="tab-pane fade" id="federationSharesPane" role="tabpanel">
        <div class="row">
          <div class="col-lg-6 mb-3">
            <div class="federation-panel h-100">
              <div class="d-flex justify-content-between align-items-center mb-3"><h2 class="h5 mb-0">Shares/received</h2><span id="federationReceivedCount" class="badge badge-secondary">0</span></div>
              <div id="federationReceivedShares"><div class="small text-muted">Cargando...</div></div>
            </div>
          </div>
          <div class="col-lg-6 mb-3">
            <div class="federation-panel h-100">
              <div class="d-flex justify-content-between align-items-center mb-3"><h2 class="h5 mb-0">Shares/sent</h2><span id="federationSentCount" class="badge badge-secondary">0</span></div>
              <div id="federationSentShares"><div class="small text-muted">Cargando...</div></div>
            </div>
          </div>
        </div>
      </section>
