...
customsOk(str_contains($providerRepo, "Status = 'pending'"), 'backend compartido conserva Solicitudes pendientes');
customsOk(str_contains($providerRepo, "Status = 'active'"), 'sólo aprobación convierte relación privilegiada en activa');
