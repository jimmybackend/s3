...
$contracts = [
    ...
    [$files['helper'], "'version' => 11", 'helper versión 11'],
    ...
    [$files['helper'], "'media-worker-status'", 'estado worker multimedia'],
    [$files['helper'], "'media-tools'", 'herramientas multimedia'],
    [$files['helper'], "'logs-media'", 'logs multimedia'],
    ...
    [$files['ec2'], 'data-console-command="systemctl status arcadecloud-media-worker"', 'botón media worker'],
