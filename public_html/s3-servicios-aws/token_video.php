...
<title><?= htmlspecialchars($nombre, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?> · Video compartido</title>
<style>
...
<body>
  <div class="wrap">
    ...
    <div class="box">
      <video controls playsinline preload="metadata" src="<?= htmlspecialchars($url, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>"></video>
    </div>
    <div class="meta">
